...
huevo.Juego2.prototype = {
	create: function() {
		...
		//cuenta = this.game.add.text(this.game.world.width - 150, 10, 'Vidas : ' + vidas, {
		//	font: '34px Arial',
		//	fill: '#fff'
		//	});
		//puntuacion = this.game.add.text(this.game.world.width - 790, 10, 'Puntos: ' + puntos, {
		//	font: '34px Arial',
		//	fill: '#fff'
		//});
		for (var i = 0; i < 12; i++) {
