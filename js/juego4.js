...
huevo.Juego4.prototype = {
	create: function() {
		...
		this.sonido.play();
		this.game.add.image(0, 0, 'fondo4');
		plataformas = this.game.add.group();
		plataformas.enableBody = true;
		var repisa = plataformas.create(500, 300, 'plataforma');
		repisa.body.immovable = true;
		repisa = plataformas.create(-125, 400, 'plataforma');
		repisa.body.immovable = true;
		var movil = plataformas.create(-175, 250, 'plataforma');
